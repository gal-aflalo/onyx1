...
*/}}
{{- define "nlq-compile.sisense.version" -}}
...
Common labels
*/}}
{{- define "nlq-compile.labels" -}}
release: {{ .Release.Name }}
app: {{ template "nlq-compile.name" . }}
chart: {{ template "nlq-compile.chart" . }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
sisense-version: {{ include "nlq-compile.sisense.version" . }}
{{- if .Values.labels -}}
...
*/}}
{{- define "nlq-compile.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "nlq-compile.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
*/}}
{{- define "nlq-compile.limits.memory" -}}
