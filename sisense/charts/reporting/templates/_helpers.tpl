...
*/}}
{{- define "reporting.sisense.version" -}}
...
chart: {{ template "reporting.chart" . }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
sisense-version: {{ include "reporting.sisense.version" . }}
{{- if .Values.labels -}}
...
*/}}
{{- define "reporting.limits.memory" -}}
