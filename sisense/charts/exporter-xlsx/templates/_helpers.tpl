...
*/}}
{{- define "exporter-xlsx.sisense.version" -}}
...
Common labels
*/}}
{{- define "exporter-xlsx.labels" -}}
release: {{ .Release.Name }}
app: {{ template "exporter-xlsx.name" . }}
exporter-xlsx-service: "true"
chart: {{ template "exporter-xlsx.chart" . }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
sisense-version: {{ include "exporter-xlsx.sisense.version" . }}
{{- if .Values.labels -}}
...
*/}}
{{- define "exporter-xlsx.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "exporter-xlsx.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
*/}}
{{- define "exporter-xlsx.limits.cpu" -}}
...
*/}}
{{- define "exporter-xlsx.limits.memory" -}}
