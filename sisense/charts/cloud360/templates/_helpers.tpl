...
*/}}
{{- define "cloud360.name" -}}
{{- default .Chart.Name .Values.nameOverride | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{- define "cloud360.namespace" -}}
{{- .Release.Namespace -}}
{{- end -}}
...
*/}}
{{- define "cloud360.sisense.version" -}}
...
Common labels
*/}}
{{- define "cloud360.labels" -}}
release: {{ .Release.Name }}
app: {{ template "cloud360.name" . }}
chart: {{ template "cloud360.chart" . }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
sisense-version: {{ include "cloud360.sisense.version" . }}
{{- if .Values.labels -}}
...
*/}}
{{- define "cloud360.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "cloud360.fullname" .) .Values.serviceAccount.name }}
{{- else }}
