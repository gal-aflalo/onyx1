...
*/}}
{{- define "management.sisense.version" -}}
...
app: {{ template "management.name" . }}
chart: {{ template "management.chart" . }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
sisense-version: {{ include "management.sisense.version" . }}
{{- if .Values.labels -}}
...
*/}}
{{- define "management.limits.memory" -}}
