...
monitoring-api: "true"
usage-service: "true"
chart: {{ template "usage.chart" . }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
sisense-version: {{ include "usage.sisense.version" . }}
{{- if .Values.labels -}}
...
{{- default (include "usage.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
{{- printf "%s" .Values.monitoring.nameOverride | trunc 63 | trimSuffix "-"  -}}
{{- end -}}
