...
*/}}
{{- define "migration.sisense.version" -}}
...
app.kubernetes.io/name: {{ template "migration.name" . }}
helm.sh/chart: {{ include "migration.chart" . }}
app.kubernetes.io/instance: {{ .Release.Name }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
sisense-version: {{ include "migration.sisense.version" . }}
{{- if .Values.labels -}}
...
*/}}
{{- define "migration.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "migration.fullname" .) .Values.serviceAccount.name }}
{{- else }}
