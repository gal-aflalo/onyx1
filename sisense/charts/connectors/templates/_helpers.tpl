...
*/}}
{{- define "connectors.sisense.version" -}}
...
chart: {{ template "connectors.chart" . }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
sisense-version: {{ include "connectors.sisense.version" . }}
{{- if .Values.labels -}}
...
*/}}
{{- define "connectors.limits.memory" -}}
