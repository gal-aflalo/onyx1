...
chart: {{ template "quest.chart" . }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
sisense-version: {{ include "quest.sisense.version" . }}
{{- if .Values.labels -}}
...
*/}}
{{- define "quest.replicas" -}}
{{- if .Values.replicaCount -}}
{{- .Values.replicaCount -}}
{{- else if .Values.global.offlineInstaller -}}
{{- 0 -}}
{{- else -}}
{{- 1 -}}
{{- end -}}
