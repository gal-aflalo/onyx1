...
*/}}
{{- define "model-logspersistence.name" -}}
...
*/}}
{{- define "model-logspersistence.fullname" -}}
...
*/}}
{{- define "model-logspersistence.chart" -}}
...
*/}}
{{- define "model-logspersistence.sisense.version" -}}
...
Common labels
*/}}
{{- define "model-logspersistence.labels" -}}
release: {{ .Release.Name }}
app: {{ template "model-logspersistence.name" . }}
ECMLogsPersistenceService: "true"
chart: {{ template "model-logspersistence.chart" . }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
sisense-version: {{ include "model-logspersistence.sisense.version" . }}
{{- if .Values.labels -}}
...
*/}}
{{- define "model-logspersistence.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "model-logspersistence.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
*/}}
{{- define "model-logspersistence.limits.cpu" -}}
...
*/}}
{{- define "model-logspersistence.limits.memory" -}}
