...
*/}}
{{- define "analyticalengine.fullname" -}}
...
*/}}
{{- define "analyticalengine.sisense.version" -}}
...
Common labels
*/}}
{{- define "analyticalengine.labels" -}}
release: {{ .Release.Name }}
app: {{ template "analyticalengine.name" . }}
analytical-engine: "true"
chart: {{ template "analyticalengine.chart" . }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
sisense-version: {{ include "analyticalengine.sisense.version" . }}
{{- if .Values.labels -}}
...
*/}}
{{- define "analyticalengine.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "analyticalengine.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
*/}}
{{- define "analyticalengine.limits.cpu" -}}
...
*/}}
{{- define "analyticalengine.limits.memory" -}}
...
*/}}
{{- define "analyticalengine.replicas" -}}
