...
*/}}
{{- define "knowledgegraph.sisense.version" -}}
...
*/}}
{{- define "knowledgegraph.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "knowledgegraph.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
*/}}
{{- define "knowledgegraph.limits.cpu" -}}
...
*/}}
{{- define "knowledgegraph.limits.memory" -}}
