...
chart: {{ template "query.chart" . }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
sisense-version: {{ include "query.sisense.version" . }}
{{- if .Values.labels -}}
