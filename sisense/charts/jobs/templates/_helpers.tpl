...
app: {{ template "jobs.name" . }}
jobs-service: "true"
chart: {{ template "jobs.chart" . }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
sisense-version: {{ include "jobs.sisense.version" . }}
{{- if .Values.labels -}}
