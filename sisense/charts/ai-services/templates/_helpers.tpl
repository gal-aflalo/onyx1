...
*/}}
{{- define "ai-services.sisense.version" -}}
...
ai-services-service: "true"
chart: {{ template "ai-services.chart" . }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
sisense-version: {{ include "ai-services.sisense.version" . }}
{{- if .Values.labels -}}
...
*/}}
{{- define "ai-services.limits.memory" -}}
