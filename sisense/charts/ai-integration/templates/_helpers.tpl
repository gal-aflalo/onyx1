...
*/}}
{{- define "ai-integration.fullname" -}}
...
*/}}
{{- define "ai-integration.sisense.version" -}}
...
Common labels
*/}}
{{- define "ai-integration.labels" -}}
release: {{ .Release.Name }}
app: {{ template "ai-integration.name" . }}
chart: {{ template "ai-integration.chart" . }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
sisense-version: {{ include "ai-integration.sisense.version" . }}
{{- if .Values.labels -}}
...
*/}}
{{- define "ai-integration.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "ai-integration.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
*/}}
{{- define "ai-integration.limits.cpu" -}}
...
*/}}
{{- define "ai-integration.limits.memory" -}}
...
*/}}
{{- define "ai-integration.replicas" -}}
