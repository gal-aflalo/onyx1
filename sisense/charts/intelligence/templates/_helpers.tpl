...
*/}}
{{- define "intelligence.sisense.version" -}}
...
sisense-version: {{ include "intelligence.sisense.version" . }}
{{- if .Values.labels -}}
...
*/}}
{{- define "intelligence.limits.cpu" -}}
...
*/}}
{{- define "intelligence.limits.memory" -}}
