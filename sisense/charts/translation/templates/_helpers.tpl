...
*/}}
{{- define "translation.sisense.version" -}}
...
translation-service: "true"
chart: {{ template "translation.chart" . }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
sisense-version: {{ include "translation.sisense.version" . }}
{{- if .Values.labels -}}
...
*/}}
{{- define "translation.limits.memory" -}}
